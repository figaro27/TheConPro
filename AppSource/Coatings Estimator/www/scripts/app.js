        ...
        var purchase = {
          ...
          views: {
            'content@index': {
              ...
              templateUrl: 'views/common/purchase.html'
            }
          },
          data: {
            access: [AccessLevels.user],
        ...
        var systems = {
            ...
            views: {
                'content@index': {
                    ...
                    controller: ['$scope', '$state', 'models', '$rootScope', 'IAP', 'Config',
                      function ($scope, $state, models, $rootScope, IAP, Config) {
                        $scope.Models = models;
    ...
    function ($rootScope, $ionicPlatform, $state, $stateParams, $ionicLoading, $ionicPopup, $window, Authorization, Config, Log, $templateCache) {
      ...
      $rootScope.hideLoadingWheel();
        ...
        $rootScope.$on('$stateChangeSuccess', function (event, toState, toParams, fromState, fromParams) {
          ...
          if (toState.name == "index.newsystem") {
            $rootScope.$broadcast(Config.SystemLimitation);
          }
