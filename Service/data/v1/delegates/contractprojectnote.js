...
var Q = require('q'),
    base = require('./base')(),
    objectType = 'contractprojectnote',
    teamDelegate = require('./team');

var contractprojectnote = function contractprojectnote() {
};
...
contractprojectnote.prototype.Populate = populate;
contractprojectnote.prototype.Build = build;
contractprojectnote.prototype.Generate = generate;
contractprojectnote.prototype.Update = update;
contractprojectnote.prototype.Search = search;
contractprojectnote.instance = null;

if (contractprojectnote.callee !== contractprojectnote.getInstance) {
    throw new Error('This object cannot be instantiated');
}

contractprojectnote.getInstance = function () {
    if (this.instance === null) {
        this.instance = new contractprojectnote();
    }
    return this.instance;
};
module.exports = contractprojectnote.getInstance();