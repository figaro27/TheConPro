angular.module('estimateApp')
  .service('System', ['$q','Service','SystemDetail','SystemTeam', function ($q, Service, SystemDetail, SystemTeam) {
    'use strict';
    var service = this;
    ...
    service.Add = function (model) {
      ...
      Service.Post(model, url.add)
        .then(function(result){
          ...
          saves.push(buildSaveTeams(result.id,model.teams));
          $q.all(saves)
      ...
      _.each(teams, function (team) {
        ...
        if(!team.leadteamid){
          if(team.checked === true){
            systemteam.systemid = id;
            systemteam.teamid = team.id;
            innerResponse.push(SystemTeam.Add(systemteam));
          }
          ...
          if(team.checked === false){
            innerResponse.push(SystemTeam.Remove(team.leadteamid));
          }
